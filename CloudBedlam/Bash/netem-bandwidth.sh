...
${TC} class add dev ${interface} parent 1:0 classid 1:1 cbq rate ${rate}kbit allot 1500 prio 1 bounded isolated 
${TC} class add dev ${interface} parent 1:0 classid 1:2 cbq rate ${rate}kbit allot 1500 prio 1 bounded isolated
